        ...
        <?php
            ...
            $res = mysqli_query($conn,$sql6);
                ...
                for($x = 1;($row = mysqli_fetch_assoc($res)); $x++){
                    ...
                    echo "<b>Name:</b> ".$row['Name']." <br><br><b>ID: </b>".$row['ID']."<br><br><b>Mobile Number:</b> ". 
                    $row['Mobile']."<br><br><b>Email:</b> ".$row['Email']."<br><br><b>Donated Amount:</b> ".$row['Amount']."<br><br><hr><br>";
                } 
